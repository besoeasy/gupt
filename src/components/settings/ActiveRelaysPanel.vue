  ...
  <div class="rounded-xl border border-zinc-800 bg-zinc-950/60 overflow-hidden shadow-xs">
    <div class="flex items-center justify-between px-4 py-2.5 border-b border-zinc-800/80">
      <div class="flex items-center gap-1.5 min-w-0">
        ...
        <p class="text-xs font-semibold tracking-tight text-zinc-200">Active Relays</p>
        <span
      ...
      <button
        @click="refresh"
        class="inline-flex h-6 w-6 items-center justify-center rounded-lg text-zinc-500 hover:bg-zinc-800 hover:text-white transition-colors cursor-pointer"
    ...
    <div v-if="allRelays.length" class="px-3 py-3 space-y-1">
      ...
      >
        ...
        <span class="font-mono truncate text-zinc-300 tracking-tight" :title="entry.relay">
        ...
        <span
          ...
          :class="entry.isActive ? 'text-emerald-400' : 'text-zinc-500'"
        >
