...
<template>
  <div
    ...
    :class="
      variant === 'surface'
        ? 'w-full border border-(--app-border) bg-(--app-surface-soft)'
        : 'border border-(--app-border) bg-[color-mix(in_srgb,var(--app-surface)_82%,transparent)] shadow-[0_16px_48px_rgba(0,0,0,0.16)]'
    "
  >
    <button
      v-for="tab in tabs"
