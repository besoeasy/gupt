    ...
    >
      <nav class="flex items-center gap-1 sm:gap-1.5 shrink-0" aria-label="Primary navigation">
        ...
        <a
          ...
          class="group relative flex h-10 w-10 shrink-0 cursor-pointer items-center justify-center rounded-2xl text-purple-400 bg-purple-500/10 hover:bg-purple-500/20 transition-all duration-300 active:scale-95 sm:h-11 sm:w-11"
