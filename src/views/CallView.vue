...
<template>
  <div class="call-shell relative flex h-dvh w-full flex-col overflow-hidden">
    ...
    <!-- Top bar -->
    <header
      class="relative z-20 flex items-center gap-3 border-b border-(--app-border) bg-(--nav-bg) px-4 py-3 backdrop-blur-xl"
    >
      <button
        type="button"
    ...
    <!-- Controls -->
    <footer
      class="relative z-20 border-t border-(--app-border) bg-(--nav-bg) px-4 py-5 backdrop-blur-xl"
    >
