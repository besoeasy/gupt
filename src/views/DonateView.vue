...
<template>
 ...
 <!-- GitHub Sponsors -->
 <section class="animate-[donate-rise_520ms_var(--app-ease-standard)_both] rounded-2xl p-6 border border-[color-mix(in_srgb,#a855f7_22%,var(--app-border))] bg-(--app-surface-soft) [data-theme='light']_&:bg-white [data-theme='light']_&:shadow-(--app-shadow) [data-theme='light']_&:border-[color-mix(in_srgb,#7c3aed_28%,var(--app-border))]">
 ...
 <!-- Bitcoin -->
 <section class="animate-[donate-rise_520ms_var(--app-ease-standard)_both] rounded-2xl p-6 border border-[color-mix(in_srgb,#f59e0b_18%,var(--app-border))] bg-(--app-surface-soft) [data-theme='light']_&:bg-white [data-theme='light']_&:shadow-(--app-shadow) [data-theme='light']_&:border-[color-mix(in_srgb,#d97706_24%,var(--app-border))]">
 <div class="flex items-start justify-between gap-3">
 <div class="flex-1 min-w-0">
 <span
