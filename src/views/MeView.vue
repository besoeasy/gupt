...
<template>
  <div class="me-view min-h-screen">
    <main class="app-page-shell mx-auto px-4 py-6 lg:px-8">
      <div class="mx-auto max-w-2xl space-y-5">
        <!-- Header -->
        <section class="me-hero ui-panel rounded-3xl p-5 sm:p-6">
        ...
        <section
          ...
          class="ui-panel rounded-2xl p-4 sm:p-5 space-y-4"
        >
          <div class="space-y-1">
        ...
        <section v-else-if="activeTab === 'identity'" class="space-y-4">
          <div v-if="npub" class="ui-panel rounded-2xl p-4 space-y-3">
            <div class="flex items-start justify-between gap-3">
              ...
              <button
                type="button"
                class="ui-icon-button inline-flex items-center gap-1 text-xs px-3 py-1 rounded-full transition-colors shrink-0"
          ...
          <div
            ...
            class="ui-panel rounded-2xl p-4 space-y-3 border border-amber-500/15"
          >
            <div class="flex items-start justify-between gap-3">
              <div>
              ...
              <button
                type="button"
                class="ui-icon-button inline-flex items-center gap-1.5 text-xs px-3 py-1 rounded-full transition-colors shrink-0"
