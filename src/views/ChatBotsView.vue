        ...
        <section class="space-y-4">
          ...
          <div v-if="publicBotsLoading" class="grid gap-3 sm:grid-cols-2">
            <div
              v-for="item in 4"
              :key="item"
              class="animate-pulse rounded-2xl border border-(--app-border) bg-(--app-surface) p-4"
            >
          ...
          <div
            ...
            class="flex flex-col items-center rounded-2xl border border-dashed border-(--app-border) bg-(--app-surface) px-5 py-12 text-center"
          >
            <span
